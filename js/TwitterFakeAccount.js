class TwitterFakeAccount
{
    ...
    {
        var objNodes = document.getElementsByClassName("ext-EthereumAssistant-tweet-" + objData.tweet_id);
        for (var intCounter = 0; intCounter < objNodes.length; intCounter++) {
            var objNode = objNodes[intCounter];
            if (objNode.getAttribute("ext-EthereumAssistant-twitterflagged")) {
                return;
            }
            ...
            objNode.setAttribute("ext-EthereumAssistant-twitterflagged", 1);
            ...
            objWhitelistedIcon.title = "This account is not categorized by EthereumAssistant";
    ...
    doBlacklistAlert(objData)
    {
        ...
        for (var intCounter = 0; intCounter < objNodes.length; intCounter++) {
            ...
            objWhitelistedIcon.style = "display:inline;height:25px;width:25px;left:15px;";
            objWhitelistedIcon.title = "This account is blacklisted by EthereumAssistant";
            objAccountDetails.append(objWhitelistedIcon);
        }
    }
    ...
    doWhitelistAlert(objData) {
        ...
        for (var intCounter = 0; intCounter < objNodes.length; intCounter++) {
            ...
            objWhitelistedIcon.style = "display:inline;height:25px;width:25px;left:15px;";
            objWhitelistedIcon.title = "This account is whitelisted by EthereumAssistant";
            objAccountDetails.append(objWhitelistedIcon);
        }
    }
            ...
            if(document.activeElement.classList.contains("tweet-box") === false) {
                if (document.getElementsByClassName("tweet")) {
                    ...
                    for(var intCounter=0; intCounter<arrTweets.length; intCounter++) {
                        ...
                        if(arrTweets[intCounter].classList.contains("ext-EthereumAssistant-tweet-"+arrTweets[intCounter].getAttribute("data-tweet-id")) === false) {

                            arrTweets[intCounter].classList.add("ext-EthereumAssistant-tweet-" + arrTweets[intCounter].getAttribute("data-tweet-id"));
