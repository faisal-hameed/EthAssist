...
const FORM_ADDRESS_SELECTOR = '#ext-EthereumAssistant-label-address';
const FORM_NAME_SELECTOR = '#ext-EthereumAssistant-label-name';
const FORM_COLOR_SELECTOR = '#ext-EthereumAssistant-label-color';
...
class Labels {
    ...
    getTemplate(name, color) {
        ...
        return `<span
            class='ext-EthereumAssistant-label'
    ...
    getExtendedTemplate(address, name, color) {
        ...
        return `<span
            ...
            &nbsp;
            <span style="float:right; cursor:pointer;" class="ext-EthereumAssistant-label-delete" data-ext-EthereumAssistant-label-id="${address}">x</span>
            <br/>`;
    }
    ...
    addLabelsListEvents() {
        const labelsDeleteElements = document.getElementsByClassName("ext-EthereumAssistant-label-delete");

        Array.from(labelsDeleteElements).forEach((element) => {
            element.addEventListener('click', async (event) => {
                const id = event.target.getAttribute('data-ext-EthereumAssistant-label-id');
    ...
    setupFormSubmitHandler() {
        document.getElementById('ext-EthereumAssistant-new-label-form').addEventListener('submit', async (event) => {
    ...
    async updateLabelsList() {
        ...
        document.getElementById('ext-EthereumAssistant-current-labels').innerHTML = HTMLLabels;
