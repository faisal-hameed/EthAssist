const FORM_CHAIN_LOOKUP_SELECTOR = '#ext-EthereumAssistant-chain_lookup_form';
const FORM_CHAIN_LOOKUP_INPUT_SELECTOR = '#ext-EthereumAssistant-addr_or_tx';
const FORM_CHAIN_LOOKUP_OUTPUT_SELECTOR = '#ext-EthereumAssistant-chain_lookup_output';
const FORM_CHAIN_LOOKUP_DETAILS_SELECTOR = '#ext-EthereumAssistant-chain_lookup_details';
