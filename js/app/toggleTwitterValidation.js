const TWITTER_CHECKBOX_SELECTOR = '[name="ext-EthereumAssistant-twitter_validation"]';
...
function toggleTwitterValidation()
{
    ...
    localStorage.setItem("ext-EthereumAssistant-twitter_validation", intTwitterValidation);
...
function refreshTwittertOption()
{
    ...
    if(localStorage.getItem("ext-EthereumAssistant-twitter_validation") === null) {
        ...
        intTwitterValidation = localStorage.getItem("ext-EthereumAssistant-twitter_validation");
    }
