const HIGHLIGHT_CHECKBOX_SELECTOR = '[name="ext-EthereumAssistant-show_style"]';
...
function toggleMatchHighlight()
{
    ...
    localStorage.setItem("ext-EthereumAssistant-show_style", intShowHighlight);
...
function refreshHighlightOption()
{
    ...
    var intShowHighlight = localStorage.getItem("ext-EthereumAssistant-show_style");
