...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var bsn = factory();
        root.ext_EthereumAssistant_Popover = bsn.ext_EthereumAssistant_Popover;
        root.ext_EthereumAssistant_Tab = bsn.ext_EthereumAssistant_Tab;
    }
}(this, function () {
    ...
    var globalObject = typeof global !== 'undefined' ? global : this||window,
        ...
        // components
        stringPopover   = 'ext_EthereumAssistant_Popover',
        stringTab       = 'ext_EthereumAssistant_Tab',
    ...
    // POPOVER DEFINITION
    // ==================
    var ext_EthereumAssistant_Popover = function( element, options ) {
        ...
        var triggerData = element[getAttribute](dataTrigger), // click / hover / focus
            ...
            // internal strings
            component = 'ext-EthereumAssistant-popover',
            template = 'template',
            trigger = 'trigger',
            classString = 'class',
            div = 'div',
    ...
    // POPOVER DATA API
    // ================
    initializeDataAPI(stringPopover, ext_EthereumAssistant_Popover, DOC[querySelectorAll]('['+dataToggle+'="ext-EthereumAssistant-popover"]'));
    ...
    // TAB DEFINITION
    // ==============
    var ext_EthereumAssistant_Tab = function( element, options ) {
        ...
        var heightData = element[getAttribute](dataHeight),
            ...
            // strings
            component = 'ext-EthereumAssistant-tab',
        ...
        // bind, event targets
        var self = this, next,
            tabs = getClosest(element,'.ext-EthereumAssistant-nav'),
    ...
    // TAB DATA API
    // ============
    initializeDataAPI(stringTab, ext_EthereumAssistant_Tab, DOC[querySelectorAll]('['+dataToggle+'="ext-EthereumAssistant-tab"]'));

    return {
        ext_EthereumAssistant_Popover: ext_EthereumAssistant_Popover,
        ext_EthereumAssistant_Tab: ext_EthereumAssistant_Tab
    };
}));
